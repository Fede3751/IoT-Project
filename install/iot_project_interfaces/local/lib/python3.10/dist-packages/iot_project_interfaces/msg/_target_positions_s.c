...
bool iot_project_interfaces__msg__target_positions__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("iot_project_interfaces.msg._target_positions.TargetPositions", full_classname_dest, 60) == 0);
  }
  iot_project_interfaces__msg__TargetPositions * ros_message = _ros_message;
  {  // positions
...
PyObject * iot_project_interfaces__msg__target_positions__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("iot_project_interfaces.msg._target_positions");
