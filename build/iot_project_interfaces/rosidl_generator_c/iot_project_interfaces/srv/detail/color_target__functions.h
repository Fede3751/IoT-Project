...
#ifndef IOT_PROJECT_INTERFACES__SRV__DETAIL__COLOR_TARGET__FUNCTIONS_H_
#define IOT_PROJECT_INTERFACES__SRV__DETAIL__COLOR_TARGET__FUNCTIONS_H_
...
/// Initialize srv/ColorTarget message.
/**
...
/// Finalize srv/ColorTarget message.
/**
...
/// Create srv/ColorTarget message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * iot_project_interfaces__srv__ColorTarget_Request__init().
...
/// Destroy srv/ColorTarget message.
/**
 * It calls
 * iot_project_interfaces__srv__ColorTarget_Request__fini()
...
/// Check for srv/ColorTarget message equality.
/**
...
/// Copy a srv/ColorTarget message.
/**
...
/// Initialize array of srv/ColorTarget messages.
/**
...
/// Finalize array of srv/ColorTarget messages.
/**
 * It calls
 * iot_project_interfaces__srv__ColorTarget_Request__fini()
...
/// Create array of srv/ColorTarget messages.
/**
 * It allocates the memory for the array and calls
 * iot_project_interfaces__srv__ColorTarget_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/ColorTarget messages.
/**
 * It calls
 * iot_project_interfaces__srv__ColorTarget_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/ColorTarget message array equality.
/**
...
/// Copy an array of srv/ColorTarget messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * iot_project_interfaces__srv__ColorTarget_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_iot_project_interfaces
...
/**
 * It calls
 * iot_project_interfaces__srv__ColorTarget_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_iot_project_interfaces
...
/**
 * It allocates the memory for the array and calls
 * iot_project_interfaces__srv__ColorTarget_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_iot_project_interfaces
...
/**
 * It calls
 * iot_project_interfaces__srv__ColorTarget_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // IOT_PROJECT_INTERFACES__SRV__DETAIL__COLOR_TARGET__FUNCTIONS_H_
