...
class Init_TargetManagerInterface_Request_targets
{
public:
  Init_TargetManagerInterface_Request_targets()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  ::iot_project_interfaces::srv::TargetManagerInterface_Request targets(::iot_project_interfaces::srv::TargetManagerInterface_Request::_targets_type arg)
  {
...
private:
  ::iot_project_interfaces::srv::TargetManagerInterface_Request msg_;
};
...
{
  return iot_project_interfaces::srv::builder::Init_TargetManagerInterface_Request_targets();
}
...
public:
  ...
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_TargetManagerInterface_Response_last_visits targets(::iot_project_interfaces::srv::TargetManagerInterface_Response::_targets_type arg)
  {
    msg_.targets = std::move(arg);
