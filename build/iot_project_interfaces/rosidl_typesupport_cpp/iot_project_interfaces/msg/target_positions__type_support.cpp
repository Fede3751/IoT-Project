...
static const _TargetPositions_type_support_symbol_names_t _TargetPositions_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, iot_project_interfaces, msg, TargetPositions)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, iot_project_interfaces, msg, TargetPositions)),
  }
};
...
{
  return &::iot_project_interfaces::msg::rosidl_typesupport_cpp::TargetPositions_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, iot_project_interfaces, msg, TargetPositions)() {
  return get_message_type_support_handle<iot_project_interfaces::msg::TargetPositions>();
}
